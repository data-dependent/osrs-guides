...
### Exploratory problems
   ...
   14. What's the most number of times that bones to bananas can be cast in 29 ticks? <!-- one per tick, have to pick up and cast in same tick and also drop when needed -->
