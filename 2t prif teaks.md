...
We click a tree on a hitsplat tick. On the next tick, we click to cancel interacting with the tree. Commonly this is done by clicking to fletch, clicking the ground underneath us or a tree, or clicking to drop logs. Repeat this, in a two tick rhythm.

This method involves our character being flinched every other tick for a 1t skilling delay, then woodcutting instead of attacking when the timer goes off on the next tick. Since auto retaliating is only possible when your character is not interacting with anything, you must click to cancel your interaction on the tick before the hitsplat.
