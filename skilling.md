...
Here we put in some fun problems to help solidify the previous material.
   ...
   9. Is it possible to use a dragon/crystal harpoon spec during 2t swordfish without losing ticks? (Note, while moving between spots doesn't count.)
