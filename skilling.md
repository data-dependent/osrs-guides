...
### Direct problems
   ...
   7. Describe two distinct methods for 3t swordfish, where there's a roll once every three ticks. At most one method should involve attacking. <!-- 1) we have a 2t or 3t wep and alt has a 3t wep, 2) we click fish spot a tick later than for 3t barb -->
   8. Without varrock armour 4 or the mining cape, is it possible to gather two runite ore in one tick while mining a runite rock? Does having expert mining gloves change the answer? <!-- maybe with mining gloves, but, no, the successful roll stall blocks it -->
